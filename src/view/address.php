...
if (isset($_SESSION['user_login'])) {
  ...
  // FETCH CART DATA
  $fetch_cart_query = "SELECT * FROM `user_address` WHERE user_id = $user_id";
            ...
            <div class="card rounded-0 mb-3">
              <div class="card-body">
                ...
                <div class="d-grid mt-4">
                  <a href="./billing-details.php" class="btn btn-dark btn-ecomm py-3 px-5">Continue</a>
                </div>
              </div>
            </div>
          </div>
