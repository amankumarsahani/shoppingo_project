    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-12 col-xl-9">
          ...
          <?php
          $cat_id = $_GET['cat_id'];
          //   $fetch = "SELECT * FROM `products_category` 
          // INNER JOIN `products_table` ON `products_category`.`id` = `products_table`.`category_id` 
          // WHERE `products_table`.`category_id` = '$cat_id'";
          $fetch = "SELECT * FROM `products_table` WHERE category_id='$cat_id' ";
            ...
            <div class="card rounded-0">
              <div class="card-body p-2">
                <div class="d-flex align-items-center justify-content-between bg-light p-2">
                  <div class="product-count"><?php echo $count; ?> Items Found </div>
                  <form>
                      ...
                      <div class="position-relative overflow-hidden">
                        ...
                        <a href="./product-details.php?product_id=<?php echo $product_id ?>">
                          <img
                            ...
                            style="height: fit-content; width:fit-content; object-fit:cover; " class="card-img-top"
                            alt="...">
                        </a>
                      </div>
